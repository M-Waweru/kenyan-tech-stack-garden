...
**Purpose:** Align the manuscript with verifiable facts, add inline citations to actual stories and sources, and track coverage gaps between the [Structure](The%20Structure.md) and the written book parts.
...
**Workspace note:** This file lives under `book/` — the Cursor / manuscript workspace. The `kenyan-tech-stack-garden/` tree is for Obsidian Quartz sync; avoid duplicating editorial work there to prevent drift.
